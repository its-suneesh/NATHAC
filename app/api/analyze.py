...
async def fetch_student_data_from_url(url: str) -> StudentRequestData:
    """
    Fetches JSON data from the provided URL and converts it into
    the internal StudentRequestData Pydantic model.
    """
...
async def analyze_student(
    ...
    1. Accepts a URL to fetch student data.
    2. Fetches and validates the data (internal function).
    3. Uses LLM to predict risk.
    """

    try:
        student_data = await fetch_student_data_from_url(request.url)
